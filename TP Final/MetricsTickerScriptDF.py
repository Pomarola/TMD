...
def analyze_ticker(ticker):
    ...
    try:
        ...
        price_data = stock.history(start="2023-10-29", end="2023-11-02")
        print(f"{ticker} Price Data:\n", price_data)

        ticker_results['Stock Price Change'] = ((price_end - price_start) / price_start) * 100 if price_start else np.nan
    except Exception as e:
